      ...
      <div class="top">
        <div
          ...
          :class="{
            ...
            checked: Object.values(item.checkedObj).includes(true)
          }"
        >
          <span>{{ item.name }}</span>
          <b></b>
          ...
          <div class="wrapper">
            <ul>
              <li
                ...
                :key="son.code"
                @click="handleItem(item.checkedObj, son.code)"
                :class="{
                  checked: item.checkedObj[son.code]
                }"
              >
                {{ son.description }}
              </li>
            ...
            <div class="btn">
              <span @click="handleReset(item.checkedObj)">重置</span>
...
export default {
  ...
  methods: {
    // 点击某一项
    handleItem(checkedObj, code) {
      if (checkedObj[code]) {
        checkedObj[code] = false;
      } else {
        checkedObj[code] = true;
      }
      this.$forceUpdate();
    },
    // 点击重置
    handleReset(checkedObj) {
      Object.keys(checkedObj).map((key) => {
