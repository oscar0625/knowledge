<template>
  <div class="resource-page">
    ...
    <div class="resource__content">
      <!-- 专家隐藏领域筛选 -->
      <template v-if="currentType === 'expert'">
      ...
      <div class="wrapper">
        ...
        <div class="result">
          ...
          <template v-else>
            ...
            <template v-if="currentType === 'expert'">
              <expert-list :dataList="queryResult" />
            </template>
          </template>
        </div>
      </div>
...
import ExpertList from "@/common/resource/expert_list";
export default {
  name: "ResourcePage",
  components: {
    Backtop,
  ...
  methods: {
    ...
    loadList(clear = true) {
      ...
      this.$api(
        ...
        if (clear) {
          this.queryResult = res.data || res.dataList;
        } else {
          this.queryResult.push.apply(
            this.queryResult,
