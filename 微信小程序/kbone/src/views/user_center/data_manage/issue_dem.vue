        ...
        <mp-form-page class="formpage">
          <mp-form class="form" ref="ruleForm" :rules="rules" :models="form">
            <mp-cells>
              ...
              <mp-cell show-error="true" prop="budgetUp">
                <div slot="title">
                  <div class="title">预算上线</div>
                </div>
                <wx-input
                  class="wx-input"
                  type="digit"
              ...
              <mp-cell show-error="true" prop="closingTime">
                ...
                >
                  <div :class="form.closingTime.length === 0 && 'unselect'">
                    {{ form.closingTime || "请填写截止时间（必填）" }}
                  </div>
                </wx-picker>
              </mp-cell>
              <mp-cell show-error="true" prop="keyWords">
                <div slot="title">
...
export default {
  ...
  methods: {
    ...
    loadAddData() {
      ...
      this.$api("demand", "addDem", params).then((res) => {
    ...
    loadInfo() {
      const { id } = this.$route.query;
      this.$api("demand", "getDemInfo", { id }).then((res) => {
