    ...
    <div class="wrapper">
      <div class="content">
            ...
            <mp-cells>
              <mp-cell show-error="true" prop="specialFieldId">
                ...
                <div class="select-container">
                  <enumerate
                    url="/api/achievement/getimproductfield"
        ...
        <mp-form-page class="formpage">
          <mp-form class="form" ref="ruleForm" :rules="rules" :models="form">
            <mp-cells>
              <div class="vertical-title">成果类型：产品类</div>
...
export default {
  ...
  methods: {
    ...
    loadAddData() {
      ...
      this.$api("achievement", "addProdAch", params).then((res) => {
    ...
    loadModifyData() {
      ...
      this.$api("achievement", "addProdAch", {
        ...params,
        id
      }).then((res) => {
        this.isLoading = false;
